...
using OracleMySql::MySql.Data.MySqlClient;
using Xunit;
...
namespace Evolve.IntegrationTest.MySQL
{
    ...
    public class DialectTest
    {
        ...
        public void Run_all_MySQL_integration_tests_work()
        {
            ...
            var cnn = new MySqlConnection(_mySQLFixture.CnxStr);
            cnn.Open();
            ...
            var migrationScript = new FileMigrationScript(TestContext.MySQL.EmptyMigrationScriptPath, "1_3_2", "Migration_description");
