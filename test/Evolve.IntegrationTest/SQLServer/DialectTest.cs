...
namespace Evolve.IntegrationTest.SQLServer
{
    ...
    public class DialectTest
    {
        ...
        public DialectTest(SQLServerFixture sqlServerFixture)
        {
            ...
            TestUtil.CreateSqlServerDatabase(DbName, _sqlServerFixture.GetCnxStr("master"));
        }
        ...
        public void Run_all_SQLServer_integration_tests_work()
        {
            ...
            var cnn = new SqlConnection(_sqlServerFixture.GetCnxStr(DbName));
            cnn.Open();
            ...
            var cnn2 = new SqlConnection(_sqlServerFixture.GetCnxStr(DbName));
